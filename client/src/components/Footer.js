...
export default function Footer() {
  return (
    <footer className="relative bg-slate-950 border-t border-slate-900/60 pt-16 pb-8 overflow-hidden text-left text-slate-400">
      ...
      {/* Tech Grid Mesh + Neon Cyberpunk Background Glows */}
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12 border-b border-slate-900">
          ...
          {/* COLUMN 1: NEXA PLATFORM CONSOLE BRANDING */}
          <div className="space-y-4">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-sm font-black tracking-widest text-white uppercase tracking-wider font-mono">
          ...
          {/* COLUMN 2: INTERNAL PLATFORM ENDPOINTS */}
          ...
          {/* COLUMN 3: DEPLOYED BACKEND STACK SUMMARY */}
          <div className="space-y-3">
          ...
          {/* COLUMN 4: SYSTEM OPERATIONAL STATUS TERMINAL */}
          <div className="space-y-3">
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-[10px] font-mono font-bold text-slate-600">
          ...
          <div className="flex items-center gap-6 uppercase tracking-wider">
            {/* ✅ Fixed Accessibility Dead Links by referencing safe route pointers */}
            <Link to="/dashboard" className="hover:text-slate-400 transition-all">Privacy</Link>
            <Link to="/dashboard" className="hover:text-slate-400 transition-all">API Specs</Link>
            <Link to="/dashboard" className="hover:text-slate-400 transition-all">Security Shell</Link>
          </div>
        </div>
