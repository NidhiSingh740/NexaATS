      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-sm text-gray-400 max-w-xs mx-auto">AI analyzes semantic context alongside keyword frequency metrics targeting specific job descriptions.</p>
          </div>
